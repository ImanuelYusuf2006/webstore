                ...
                <div>
                    <div class="space-y-3">
                        <input type="text" placeholder="Search" wire:model="search"
                            class="@error('search') border-red-500 @enderror sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                        @error('search')
                    ...
                    <div class="grid grid-cols-2 mt-10">
                        ...
                        wire:Loading.attr="disabled"
                            ...
                            Apply Filter
                            <div wire:loading class="animate-spin inline-block size-4 border-3 border-current border-t-transparent rounded-[999px] text-primary"
