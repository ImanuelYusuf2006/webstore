                            ...
                            <div x-data="{ open: false }" class="relative w-full">
                                <div class="relative">
                                    ...
                                    <div wire:loading wire:target="region_selector.keyword"
                                        class="absolute right-3 top-3 animate-spin inline-block size-4 border-3 border-current border-t-transparent rounded-[999px] text-primary"
